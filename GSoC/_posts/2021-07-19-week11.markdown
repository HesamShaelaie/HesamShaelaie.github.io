...
# Future contributions:
 ...
 |[Four](https://hesamshaelaie.github.io/gsoc/2021/06/28/week4.html)    | Learning the input structure of MibS                 |1. [Notes] on the structure of input({{ site.url }}/images/SC.png)|
